...
s.source	= { :git => "https://github.com/ooyala/ios-sample-apps.git", :tag => "v4.16.0_GA"}
...
s.frameworks	= "CoreMedia", "QuartzCore", "AVFoundation", "MediaPlayer", "MediaAccessibility", "SystemConfiguration","AVKit"
