#
#  Be sure to run `pod spec lint OoyalaFreewheelSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "3.5.0"
  s.summary      = "Ooyala Freewheel SDK"

  s.description  = <<-DESC
                   A longer description of OoyalaFreewheelSDK in Markdown format.
  ...
  # Or just: s.author    = "Yi Gu"
  # s.authors            = { "Yi Gu" => "yigu@ooyala.com" }
  # s.social_media_url   = "https://twitter.com/guyi19900330"
