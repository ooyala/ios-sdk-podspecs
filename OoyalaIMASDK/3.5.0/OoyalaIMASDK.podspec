#
#  Be sure to run `pod spec lint OoyalaIMASDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "OoyalaIMASDK"
  s.version      = "3.5.0"
  s.summary      = "Ooyala IMA SDK"

  s.description  = <<-DESC
                   A longer description of OoyalaIMASDK in Markdown format.
  ...
  # Or just: s.author    = "yigu"
  # s.authors            = { "yigu" => "yigu@ooyala.com" }
  # s.social_media_url   = "http://twitter.com/guyi19900330"
